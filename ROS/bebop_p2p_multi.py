...
class MoveByGPS:
    ...
    def __init__(self):
        ...
        self.speed_flag1 = True
        self.speed_flag2 = True
    ...
    def move_to_target(self, g_lati, g_long, g_alti, speed):
        ...
        while not rospy.is_shutdown():
            ...
            if dist < LIMITE_DIST_10 and self.speed_flag1 == True:
                speed = speed * 0.5
                print("speed * 0.5 : %s" %(speed))
                self.speed_flag1 = False

            if dist < LIMITE_DIST_30 and self.speed_flag2 == True:
                speed = speed * 0.75
                print("speed * 0.75: %s" %(speed))
                self.speed_flag2 = False

            if dist_s2 < LIMITE_DIST:
                break
            ...
            print("goal : %.2f , current : %.2f, dist : %.2f" %(true_bearing_s1, c_bearing_s1, dist_s1))
            print("goal : %.2f , current : %.2f, dist : %.2f" %(true_bearing_s2, c_bearing_s2, dist_s2))
